...
enum action
{
	...
	ACTION_CLOSE,
	ACTION_LOWER,
	ACTION_ALTTAB, 	/**< Alt+Tab key. */
	ACTION_VOLUME,
	ACTION_TRANSPARENCY
};

/**	Enum der Maus Knoepfe. */
enum button
{
	BUTTON_NONE=0,
	BUTTON_LMB,		/**< Linker. */
	BUTTON_MMB,		/**< Mittlere Taste. */
	BUTTON_RMB,		/**< Rechte Taste. */
	BUTTON_MB4,		/**< Zusatztaste 1 (vor). */
	BUTTON_MB5		/**< Zusatztaste 1 (vor). */
};
